...
export const getWorks = (): Work[] => [
  ...
  { id: 12, title: "Per correr migliori acque", year: "2020", genre: "Poesia", publisher: "Delta3 Edizioni, Grottaminarda", description: "Opera analitica originale dall'andamento poematico sul Coronavirus, un'autentica ode civile ed etica di stampo classico. III Premio Poesia Edita al Premio Internazionale ACSI \"Firenze Capitale d'Europa\" XXIII edizione.", price: "€ 8,00" },
  { id: 13, title: "Vive l'amore e canto", year: "2022", genre: "Poesia", publisher: "Delta3 Edizioni, Grottaminarda", description: "Questo tenero \"canzoniere d'amore\" è un dettato poetico di inimitabile purezza, scandito da un'elegante sobrietà di un \"inquieto sentire\". (Carlo Di Lieto)", price: "€ 10,00" },
  ...
  { id: 21, title: "Non di solo pane", year: "2020", genre: "Narrativa (Romanzo)", publisher: "Delta3 Edizioni, Grottaminarda", description: "Il romanzo è un intreccio di autobiografia, di recupero memoriale personale e di contesto, con uno sguardo aperto sui principali valori. Una sorta di testamento valoriale da affidare ai propri cari.", price: "€ 10,00" },
