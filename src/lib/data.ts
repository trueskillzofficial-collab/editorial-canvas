...
export const getWorks = (): Work[] => [
  ...
  { id: 25, title: "Il Settecento e l'Autobiografia", year: "2010", genre: "Critica Letteraria", publisher: "Delta3 Edizioni, Grottaminarda", description: "\"Un picciolo libro tutto fatto di cose proprie\" (G.B. Vico). Le autobiografie valicano il rigido regime dell'impatto storicistico per diventare rievocazione lirica e feconda di un secolo. (Giuseppe Panella)", price: "€ 10,00" },
  ...
  { id: 27, title: "Incontro con Dante / Libertà va cercando", year: "2021", genre: "Critica Letteraria", publisher: "Prometheus Edizioni, Milano", description: "Il testo soddisfa due attese fondamentali del lettore: cogliere il messaggio dell'opera con immediatezza, e avvertire il piacere del contatto diretto con il testo. La novità è il desiderio forte di ancorare il ricordo e la celebrazione del Sommo Poeta agli snodi essenziali del viaggio oltremondano.", price: "€ 25,00" },
  // SAGGISTICA
