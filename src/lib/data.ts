...
export const getWorks = (): Work[] => [
  // POESIA
  { id: 1, title: "Colpo d'ala", year: "1978", genre: "Poesia", publisher: "C.F.D. Avellino", description: "Prima silloge poetica, in cui la poesia è qualcosa di irripetibile, che nasce dalla parte più genuina e fresca dell'io.", price: "€ 10,00", image: coverColpoDala },
  { id: 2, title: "Rari Nantes", year: "1988", genre: "Poesia", publisher: "Bastogi Edizioni, FG", description: "Raccolta poetica pubblicata con l'editore Bastogi.", price: "€ 8,00", image: coverRariNantes },
  ...
  { id: 4, title: "In gurgite vasto", year: "2004", genre: "Poesia", publisher: "Genesi Editrice, Torino", description: "Il titolo virgiliano si collega strettamente a Rari nantes e lo completa, riaffermando l'unità e la continuità di un arduo tragitto umano e poetico. Una poesia che fa sentire e che si pone il compito meritorio di far pensare. (Emerico Giachery, Davide Puccini)", price: "€ 12,00", image: coverInGurgiteVasto },
  { id: 5, title: "E la fiaccola … vive!", year: "2005", genre: "Poesia", publisher: "Delta3 Edizioni, Grottaminarda", description: "Ode ispirata alle Olimpiadi di Atene 2004, un'operazione straordinaria che intreccia passato e presente, il mito e le figure di oggi.", price: "€ 5,00", image: coverFiaccolaVive },
  { id: 6, title: "Come per acqua cupa", year: "2008", genre: "Poesia", publisher: "Delta3 Edizioni, Grottaminarda", description: "Le parole che Prebenna adopera per la poesia sono deliberatamente assunte da un ambito di solidità e di efficacia storicamente collaudate.", price: "€ 10,00", image: coverComePerAcquaCupa },
  { id: 7, title: "Era il maggio odoroso", year: "2010", genre: "Poesia", publisher: "Genesi Editrice, Torino", description: "Raccolta poetica ispirata alla natura, alla memoria e al sentimento del tempo.", price: "€ 12,00", image: coverEraIlMaggio },
  ...
  { id: 9, title: "Vulnera Temporis", year: "2018", genre: "Poesia", publisher: "Delta3 Edizioni, Grottaminarda", description: "Opera in 2 volumi con traduzione in neogreco di Maria Luigia Di Stefano e in polacco di Pawel Krupka.", price: "€ 15,00 x vol.", image: coverVulneraTemporis },
  { id: 10, title: "In una parte più e meno altrove", year: "2017", genre: "Poesia", publisher: "Genesi Editrice, Torino", description: "Raccolta poetica che esplora il senso dell'appartenenza e dello sradicamento.", price: "€ 11,00", image: coverInUnaParte },
  { id: 11, title: "In rime sparse", year: "2020", genre: "Poesia", publisher: "Il Convivio Edizioni, Castiglione di Sicilia", description: "Raccolta poetica pubblicata con Il Convivio Editore.", price: "€ 10,00", image: coverInRimeSparse },
  ...
  { id: 14, title: "Per cieli nuovi e terra nuova", year: "2024", genre: "Poesia", publisher: "Terebinto Edizioni, Avellino", description: "Raccolta poetica che guarda al futuro con speranza e rinnovamento.", price: "€ 15,00", image: coverPerCieliNuovi },
  ...
  { id: 16, title: "Fiori di campo", year: "2025", genre: "Poesia", publisher: "Il Convivio Editore, Castiglione di Sicilia", description: "Ultima raccolta poetica pubblicata con Il Convivio Editore.", price: "€ 8,00", image: coverFioriDiCampo },
  { id: 17, title: "L'altra faccia della luna", year: "2025", genre: "Poesia", publisher: "Genesi Editrice, Torino", description: "Raccolta poetica edita con Genesi Editrice.", price: "€ 16,00", image: coverAltraFacciaLuna },
  // NARRATIVA
  { id: 18, title: "L'approdo", year: "1976", genre: "Narrativa", publisher: "C.F.D. Avellino", description: "Prima opera narrativa, legata alla specificità territoriale e all'avventura scolastica e di lavoro del protagonista.", price: "€ 10,00", image: coverApprodo },
  { id: 19, title: "Tempo che va", year: "1995", genre: "Narrativa", publisher: "L'Autore Libri, Firenze", description: "Raccolta di racconti che seguono le tracce del sentimento.", price: "€ 8,00", image: coverTempoCheVa },
  ...
  { id: 21, title: "Non di solo pane", year: "2020", genre: "Narrativa (Romanzo)", publisher: "Delta3 Edizioni, Grottaminarda", description: "Il romanzo è un intreccio di autobiografia, di recupero memoriale personale e di contesto, con uno sguardo aperto sui principali valori. Una sorta di testamento valoriale da affidare ai propri cari.", price: "€ 10,00", image: coverNonSoloDiPane },
  ...
  { id: 24, title: "Pietro Paolo Parzanese: l'intellettuale che si volle poeta popolare", year: "2006", genre: "Critica Letteraria", publisher: "Delta3 Edizioni, Grottaminarda", description: "Dalla lettura delle opere poetiche e prosastiche di Parzanese emerge la natura didascalica, educativa, volutamente propositiva della sua produzione letteraria. (Giuseppe Panella, Scuola Normale Superiore di Pisa)", price: "€ 10,00", image: coverParzanese },
  ...
  // SAGGISTICA
  { id: 28, title: "Scuola oggi", year: "1986", genre: "Saggistica", publisher: "Edizioni Bastogi, FG", description: "Saggio sul mondo della scuola e le sfide dell'educazione.", price: "€ 8,00", image: coverScuolaOggi },
